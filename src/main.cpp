...
//unsigned int duree = 10 * 1000; // par défaut 10s d'arrosage
//unsigned int frequence = 4*60*60*1000;    //par défaut  toutes les 4 heures
String documentPath = "serre";
#define DHTTYPE DHT22                   // DHT 22  (AM2302)
DHTesp dht;                             // Création de l'objet
char quand[29];
...
//   //****************** ECRIRE  dans FIREBASE
  void ecriredb(){
    ...
    if (debug){printf("contenu de quand %s FB date en mn\n\n", quand); }
...
// //*********************************************************************
// // ecrire les vakeurs dans FIREBASE
void loop()
{
      ...
      //fin de la fréquence arrosage ... on arrose
  {
   ...
   if(!debug) consignes = lesConsignes.lirelesconsignes();
